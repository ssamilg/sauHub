...
export default class NewPostScreen extends React.Component {
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1}}>
        <Header onPress={this.props.navigation.openDrawer} title={'Yeni Konu'} />
        <View style={{ flex: 1, alignContent:'center', justifyContent:'center'}}>
        <KeyboardAvoidingView behavior="padding" enabled style={{width: '100%'}}>
            <View style={form}>
              <View style={{ alignSelf:'center'}}>
              <Image 
                source={{uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsDVe3e4I1SuJOVnF3whxY3dem1oCG8oLdyaGXiT2ijm1sBIYbqQ&s'}} 
