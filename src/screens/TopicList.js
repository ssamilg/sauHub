    ...
    render() {
      ...
      return (
        <View style={{flat:1}}>
          ...
          <Header onPress={this.props.navigation.openDrawer} title={'Topic List'} subtitle={this.props.navigation.getParam('id', '')}/>
          ...
          <SafeAreaView style={{flat:3}}>
            <FlatList contentContainerStyle={{ paddingBottom: 300}}
              data={topicList}
              renderItem={({ item }) => 
              <CardList
                title={ item.name} 
